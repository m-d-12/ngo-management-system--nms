...
class RegVolunteer(Frame):
    ...
    def __init__(self, master=NONE):
        ...
        self.lab = Label(self, text="Basic info", padx=10,
        ...
        self.lab4 = Label(self, text="Email id", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab5 = Label(self, text="Password", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab6 = Label(self, text="Confirm Password",
        ...
        self.lab9 = Label(self, text="Phone no", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.button = Button(self, text="Register", width=7, height=1,
                             command=self.RegVol, highlightbackground='LightGoldenrod2')
        self.button.grid(row=18, column=1, ipadx=5, padx=5, pady=10)

        self.lab14 = Label(
            self, text="*min time is 10 hrs per week", bg='LightGoldenrod2')
...
class CheckFunds(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="Class", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        self.lab1.grid(row=0, column=0, pady=10)

        self.lab2 = Label(self, text="Books", relief=FLAT,
                          width=12, height=1, bg='LightGoldenrod2')
        self.lab2.grid(row=0, column=1, pady=10)

        self.lab3 = Label(self, text="Bags", relief=FLAT,
                          width=9, height=1, bg='LightGoldenrod2')
        self.lab3.grid(row=0, column=2, pady=10)

        self.lab4 = Label(self, text="Shoes", relief=FLAT,
                          width=10, height=1, bg='LightGoldenrod2')
        self.lab4.grid(row=0, column=3, pady=10)

        self.lab5 = Label(self, text="Dress", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        ...
        self.lab6 = Label(self, text="FUNDS", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
...
class CheckStudents(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab = Label(self, text="ID", relief=FLAT,
                         width=7, height=1, bg='LightGoldenrod2')
        self.lab.grid(row=0, column=0, pady=10)

        self.lab0 = Label(self, text="Name", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        ...
        self.lab6 = Label(self, text="Fee", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
...
class CheckDonors(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="Phone", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        self.lab1.grid(row=0, column=2, pady=10)

        self.lab2 = Label(self, text="Amount", relief=FLAT,
                          width=12, height=1, bg='LightGoldenrod2')
        self.lab2.grid(row=0, column=3, pady=10)

        self.lab3 = Label(self, text="Plan", relief=FLAT,
                          width=9, height=1, bg='LightGoldenrod2')
        self.lab3.grid(row=0, column=4, pady=10)
        ...
        for Nfile in list_of_files:
            ...
            for i in range(len(VolList)):
                for j in range(3):
                    ...
                    self.e = Text(self, width=10, height=1,
                                  bg='LightGoldenrod2')
                    self.e.grid(row=i+1, column=j)
...
class RemoveVol(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="ID", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
...
class Initiate_Help(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="Total Funds",
                          height=1, bg='LightGoldenrod2')
        ...
        self.lab3 = Label(self, text="Total Registered Students",
                          height=1, bg='LightGoldenrod2')
        ...
        self.lab5 = Label(self, text="Students to be Helped",
                          height=1, bg='LightGoldenrod2')
        ...
        for i in range(len(self.StuList)):
            ...
            if self.StuList[i].NeedHelp == 1:
                ...
                if self.Inv[j-1].help.books < self.StuList[i].help.books:
                    amt = amt+self.Inv[j-1].prices.books * \
                        self.StuList[i].help.books

                if self.Inv[j-1].help.bags < self.StuList[i].help.bags:
                    amt = amt+self.Inv[j-1].prices.bags * \
                        self.StuList[i].help.bags

                if self.Inv[j-1].help.shoes < self.StuList[i].help.shoes:
                    amt = amt+self.Inv[j-1].prices.shoes * \
                        self.StuList[i].help.shoes

                if self.Inv[j-1].help.dress < self.StuList[i].help.dress:
                    amt = amt+self.Inv[j-1].prices.dress * \
                        self.StuList[i].help.dress
        ...
        if(self.Fun.funds > amt):
            for i in range(len(self.StuList)):
                if self.StuList[i].NeedHelp == 1:
                    ...
                    if self.Inv[j-1].help.books > self.StuList[i].help.books:
                        self.Inv[j-1].help.books = self.Inv[j -
                                                            1].help.books - self.StuList[i].help.books
                        InvT.help.books = self.Inv[j-1].help.books

                    else:
                        self.Fun.funds = self.Fun.funds - \
                            self.Inv[j-1].prices.books * \
                            self.StuList[i].help.books

                    StudNew.help.books = 0

                    if self.Inv[j-1].help.bags > self.StuList[i].help.bags:
                        self.Inv[j-1].help.bags = self.Inv[j -
                                                           1].help.bags-self.StuList[i].help.bags
                        InvT.help.bags = self.Inv[j-1].help.bags

                    else:
                        self.Fun.funds = self.Fun.funds - \
                            self.Inv[j-1].prices.bags*self.StuList[i].help.bags

                    StudNew.help.bags = 0

                    if self.Inv[j-1].help.shoes > self.StuList[i].help.shoes:
                        self.Inv[j-1].help.shoes = self.Inv[j -
                                                            1].help.shoes - self.StuList[i].help.shoes
                        InvT.help.shoes = self.Inv[j-1].help.shoes

                    else:
                        self.Fun.funds = self.Fun.funds - \
                            self.Inv[j-1].prices.shoes * \
                            self.StuList[i].help.shoes

                    StudNew.help.shoes = 0

                    if self.Inv[j-1].help.dress > self.StuList[i].help.dress:
                        self.Inv[j-1].help.dress = self.Inv[j -
                                                            1].help.dress - self.StuList[i].help.dress
                        InvT.help.dress = self.Inv[j-1].help.dress

                    else:
                        self.Fun.funds = self.Fun.funds - \
                            self.Inv[j-1].prices.dress * \
                            self.StuList[i].help.dress
...
class GiveHelp(Frame):
    def __init__(self, master=NONE):
        ...
        self.button1 = Button(self, text="OK", width=7, height=1,
