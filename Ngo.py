...
path = "/Applications/ss/2-2/Software/NMS/loginCred"
...
class TopFrame(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="    LOGIN PAGE   ",
                          padx=10, pady=5, bg='LightGoldenrod2')
        self.lab1.grid(row=0, column=1)
        self.lab2 = Label(self, text="User id", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab1 = Label(self, text="Password ", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab3 = Label(self, text="Login as", padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.lab3.grid(row=4, column=1, padx=10, pady=5)

        self.button3 = Button(self, text="Donor", width=12, height=1,
                              command=self.login_verify_Donor, highlightbackground='LightGoldenrod2')
        self.button3.grid(row=5, column=0)

        self.button2 = Button(self, text="volunteer", width=12, height=1,
                              command=self.login_verify_Volunteer, highlightbackground='LightGoldenrod2')
        self.button2.grid(row=5, column=1)

        self.button1 = Button(self, text="Manager", width=12, height=1,
                              command=self.login_verify_Manager, highlightbackground='LightGoldenrod2')
        self.button1.grid(row=5, column=2)

        self.button = Button(self, text="Register as Donor", width=15, height=1,
                             command=self.RegiDonor, highlightbackground='LightGoldenrod2')
    ...
    def user_not_found(self):
        ...
        Button(self.user_not_found_screen, text="OK",
               command=self.user_not_found_screen.destroy).pack()
...
class RegDonor(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="Enter the Details",
                          padx=10, pady=5, bg='LightGoldenrod2')
        self.lab1.grid(row=0, column=1)

        self.lab1 = Label(self, text="Name", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab3 = Label(self, text="Email", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab4 = Label(self, text="Password", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab5 = Label(self, text="Confirm Password",
                          padx=10, pady=5, bg='LightGoldenrod2')
        ...
        self.lab6 = Label(self, text="Phone no", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab7 = Label(self, text="Address", padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.lab7.grid(row=7, column=0, padx=10)

        self.text7 = Text(self, width=20, height=3, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text7.grid(row=7, column=1, padx=10, pady=15)

        self.lab8 = Label(self, text="Pledged amount",
                          padx=10, pady=5, bg='LightGoldenrod2')
        ...
        self.lab9 = Label(self, text="Donation Plan",
                          padx=10, pady=5, bg='LightGoldenrod2')
        ...
        self.button1 = Button(self, text="Register", width=10, height=3, padx=5,
                              pady=5, command=self.RegisterDonor, highlightbackground='LightGoldenrod2')
        self.button1.grid(row=5, column=2)
...
class Manager(Frame):
    def __init__(self, master=NONE):
        ...
        self.button1 = Button(self, text="Logout", relief=FLAT, width=7, height=1,
                              command=self.master.destroy, highlightbackground='LightGoldenrod2')
        self.button1.grid(row=4, column=1, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Register Volunteer", relief=FLAT, width=12,
                             height=1, command=self.RegVol, highlightbackground='LightGoldenrod2')
        self.button.grid(row=1, column=0, ipadx=10, padx=15, pady=10)

        self.button = Button(self, text="Notify donors", relief=FLAT, width=9,
                             height=1, command=self.notifyDonors, highlightbackground='LightGoldenrod2')
        self.button.grid(row=3, column=1, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Initiate Help", relief=FLAT, width=9,
                             height=1, command=self.initiateHelp, highlightbackground='LightGoldenrod2')
        self.button.grid(row=1, column=2, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Check Records", relief=FLAT, width=10,
                             height=1, command=self.CheckRecords, highlightbackground='LightGoldenrod2')
        self.button.grid(row=2, column=0, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Remove Volunteer", relief=FLAT, width=12,
                             height=1, command=self.remVol, highlightbackground='LightGoldenrod2')
    ...
    def CheckRecords(self):
        self.button = Button(self, text="Check Funds", relief=FLAT, width=9,
                             height=1, command=self.checkfunds, highlightbackground='LightGoldenrod2')
        self.button.grid(row=5, column=0, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Students List", relief=FLAT, width=9, height=1,
                             command=self.checkStudents, highlightbackground='LightGoldenrod2')
        self.button.grid(row=5, column=2, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Volunteers List", relief=FLAT, width=9, height=1,
                             command=self.checkvolunteers, highlightbackground='LightGoldenrod2')
        self.button.grid(row=6, column=0, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Donors List", relief=FLAT, width=9, height=1,
                             command=self.checkdonors, highlightbackground='LightGoldenrod2')
...
class Volunteer(Frame):
    ...
    def __init__(self, master=NONE):
        ...
        self.button = Button(self, text="Register Student", relief=FLAT, width=12,
                             height=1, command=self.RegStud, highlightbackground='LightGoldenrod2')
        self.button.grid(row=1, column=0, ipadx=10, padx=15, pady=10)

        self.button = Button(self, text="Set Price", relief=FLAT, width=9, height=1,
                             command=self.setPrices, highlightbackground='LightGoldenrod2')
        self.button.grid(row=0, column=2, ipadx=5, padx=15, pady=10)

        self.button = Button(self, text="Minor Donation", relief=FLAT, width=9,
                             height=1, command=self.getMinor, highlightbackground='LightGoldenrod2')
        ...
        self.button = Button(self, text="Update Profile", relief=FLAT, width=12,
                             height=1, command=self.updatepp, highlightbackground='LightGoldenrod2')
...
class PledgeDonor(Frame):
    def __init__(self, master=NONE, donorID=" "):
        ...
        self.button = Button(self, text="Logout", width=7, height=1,
                             command=self.master.destroy, highlightbackground='LightGoldenrod2')
        self.button.grid(row=0, column=0, ipadx=5, padx=5, pady=10)

        self.lab1 = Label(self, text="Update Donation",
                          padx=10, pady=5, bg='LightGoldenrod2')
        self.lab1.grid(row=1, column=1)

        self.lab2 = Label(self, text="Donation Amount",
                          padx=10, pady=5, bg='LightGoldenrod2')
        self.lab2.grid(row=2, column=0)

        self.text1 = Text(self, width=10, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab4 = Label(self, text="Change Plan", padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.lab4.grid(row=4, column=0)
        ...
        self.button = Button(self, text="Update", width=7, height=1,
                             command=self.UpdateButton, highlightbackground='LightGoldenrod2')
        ...
        if self.donBro.notified == 1:
            if self.donBro.donated == 0:
                self.button2 = Button(self, text="Donate", width=7, height=1,
                                      command=self.DonateButton, highlightbackground='LightGoldenrod2')
                ...
                if self.donBro.donated == 1:
                    self.button2 = Button(self, text="Donate", width=7, height=1,
                                          command=self.DonateButton, highlightbackground='LightGoldenrod2')
                    self.button2.grid(
                        row=6, column=1, ipadx=5, padx=5, pady=10)
