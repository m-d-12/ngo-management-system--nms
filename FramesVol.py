...
class RegStudent(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab1 = Label(self, text="Enter Data", padx=10,
        ...
        self.lab2 = Label(self, text="Date of Birth",
        ...
        self.lab3 = Label(self, text="School", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab6 = Label(self, text="Class Studying",
                          padx=10, pady=5, bg='LightGoldenrod2')
        ...
        self.lab = Label(self, text="Gender", padx=10,
                         pady=5, bg='LightGoldenrod2')
        ...
        self.lab7 = Label(self, text="Parental Income",
                          padx=10, pady=5, bg='LightGoldenrod2')
        ...
        self.lab8 = Label(self, text="Percentage", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab9 = Label(self, text="BOOKS", padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        self.lab10 = Label(self, text="BAGS", padx=10,
                           pady=5, bg='LightGoldenrod2')
        ...
        self.lab11 = Label(self, text="SHOES", padx=10,
                           pady=5, bg='LightGoldenrod2')
        ...
        self.lab12 = Label(self, text="DRESS", padx=10,
                           pady=5, bg='LightGoldenrod2')
        ...
        self.lab13 = Label(self, text="FEES", padx=10,
                           pady=5, bg='LightGoldenrod2')
        ...
        self.button = Button(self, text="Register", width=7, height=1,
                             command=self.RegStudent, highlightbackground='LightGoldenrod2')
...
class SetPrice(Frame):
    def __init__(self, master=NONE):
        ...
        self.button = Button(self, text="Update", height=1,
                             command=self.UpdatePrice, highlightbackground='LightGoldenrod2')
    ...
    def UpdatePrice(self):
        for i in range(12):
            for j in range(1, 5):
                ...
                if j == 1:
                    self.InvenC[i].prices.books = int(
                        self.textBoxR[i][j].get("1.0", "end-1c"))

                if j == 2:
                    self.InvenC[i].prices.bags = int(
                        self.textBoxR[i][j].get("1.0", "end-1c"))

                if j == 3:
                    self.InvenC[i].prices.shoes = int(
                        self.textBoxR[i][j].get("1.0", "end-1c"))

                if j == 4:
                    self.InvenC[i].prices.dress = int(
                        self.textBoxR[i][j].get("1.0", "end-1c"))
...
class MinorDonation(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab2 = Label(self, text="Frequency", relief=FLAT,
                          width=12, height=1, bg='LightGoldenrod2')
        self.lab2.grid(row=1, column=1, ipadx=10, padx=15, pady=10)

        self.lab3 = Label(self, text="Class", relief=FLAT,
                          width=12, height=1, bg='LightGoldenrod2')
        self.lab3.grid(row=4, column=2, ipadx=10, padx=15, pady=10)

        self.text1 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text1.grid(row=5, column=2, padx=10, pady=15)

        self.lab4 = Label(self, text="Books", relief=FLAT,
                          width=10, height=1, bg='LightGoldenrod2')
        self.lab4.grid(row=3, column=0, ipadx=5, padx=15, pady=10)

        self.text = Text(self, width=5, height=1, padx=10,
                         pady=5, bg='LightGoldenrod2')
        self.text.grid(row=3, column=1, padx=10, pady=15)

        self.lab5 = Label(self, text="Bags", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        self.lab5.grid(row=4, column=0, ipadx=5, padx=15, pady=10)

        self.text2 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text2.grid(row=4, column=1, padx=10, pady=15)

        self.lab6 = Label(self, text="Shoes", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        self.lab6.grid(row=5, column=0, ipadx=5, padx=15, pady=10)

        self.text4 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text4.grid(row=5, column=1, padx=10, pady=15)

        self.lab7 = Label(self, text="Dresses", relief=FLAT,
                          width=9, height=1, bg='LightGoldenrod2')
        self.lab7.grid(row=6, column=0, ipadx=5, padx=15, pady=10)

        self.text6 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text6.grid(row=6, column=1, padx=10, pady=15)

        self.lab6 = Label(self, text="Money", relief=FLAT,
                          width=12, height=1, bg='LightGoldenrod2')
        self.lab6.grid(row=7, column=0, ipadx=10, padx=15, pady=10)

        self.text9 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        self.text9.grid(row=7, column=1, padx=10, pady=15)

        self.button = Button(self, text="Accept", width=12, height=1,
                             command=self.AcceptDonation, highlightbackground='LightGoldenrod2')
...
class UpdateProfile(Frame):
    def __init__(self, master=NONE):
        ...
        self.lab0 = Label(self, text="ID", relief=FLAT,
                          width=7, height=1, bg='LightGoldenrod2')
        self.lab0.grid(row=0, column=2, pady=10)

        self.text0 = Text(self, width=5, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
        ...
        for j in range(5):
            self.e = Text(self, width=10, height=1, padx=10,
                          pady=5, bg='LightGoldenrod2')
            self.e.grid(row=3, column=j, padx=10, pady=5)

            self.Klist.append(self.e)

        self.button1 = Button(self, text="Update", width=7, height=1,
